...
export function ultragoalDir(scope) {
    return ultragoalSessionDir(scope);
}
export function ultragoalBriefPath(scope) {
    return join(ultragoalSessionDir(scope), ULTRAGOAL_BRIEF);
}
export function ultragoalGoalsPath(scope) {
    return join(ultragoalSessionDir(scope), ULTRAGOAL_GOALS);
}
export function ultragoalLedgerPath(scope) {
