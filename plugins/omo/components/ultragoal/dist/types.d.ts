export declare const ULTRAGOAL_DIR = ".omo/ultragoal";
export declare const ULTRAGOAL_SESSIONS = "sessions";
export declare const ULTRAGOAL_INDEX = "index.json";
...
export declare const ULTRAGOAL_PLATFORM: "claude";
export type UltragoalPlatform = typeof ULTRAGOAL_PLATFORM;
export type UltragoalStatus = "pending" | "in_progress" | "complete" | "failed" | "blocked" | "review_blocked" | "needs_user_decision";
...
export declare const ULTRAGOAL_STEERING_MUTATION_KINDS: readonly ["add_subgoal", "split_subgoal", "reorder_pending", "revise_pending_wording", "revise_criterion", "annotate_ledger", "mark_blocked_superseded"];
...
export declare const ULTRAGOAL_SUCCESS_CRITERION_USER_MODELS: readonly ["happy", "edge", "regression", "adversarial"];
export type UltragoalSuccessCriterionUserModel = (typeof ULTRAGOAL_SUCCESS_CRITERION_USER_MODELS)[number];
export declare const ULTRAGOAL_CRITERION_STATUSES: readonly ["pending", "pass", "fail", "blocked"];
export type UltragoalCriterionStatus = (typeof ULTRAGOAL_CRITERION_STATUSES)[number];
export declare const ULTRAGOAL_LEDGER_EVENT_KINDS: readonly ["plan_created", "goal_started", "goal_resumed", "goal_completed", "goal_blocked", "goal_failed", "goal_needs_user_decision", "goal_retried", "aggregate_completed", "aggregate_objective_migrated", "plan_migrated_to_session", "goal_added", "steering_accepted", "steering_rejected", "final_review_failed", "goal_review_blocked", "evidence_captured", "criterion_failed", "criterion_blocked", "criteria_revised"];
...
export declare const ULTRAGOAL_PLAN_VERSION: 2;
