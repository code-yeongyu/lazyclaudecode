...
export function normalizeGoalMode(value) {
    if (value === undefined)
        return "aggregate";
    if (value === "aggregate" || value === "per_story")
        return value;
    throw new UltragoalError("Invalid --goal-mode; expected aggregate or per_story.", "ULTRAGOAL_GOAL_MODE_INVALID", { details: { value } });
}
