...
const isKind = (value) => typeof value === "string" && ULTRAGOAL_STEERING_MUTATION_KINDS.some((kind) => kind === value);
const isSource = (value) => typeof value === "string" && SOURCES.some((source) => source === value);
const isModel = (value) => typeof value === "string" && ULTRAGOAL_SUCCESS_CRITERION_USER_MODELS.some((model) => model === value);
...
export function parseUltragoalSteeringDirective(text) {
...
export async function steerUltragoal(scope, proposal) {
